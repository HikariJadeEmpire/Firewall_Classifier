...
ต่อมาเราก็ได้ทำการ Plot Column 'Action' เพื่อดูสัดส่วน ก็จะได้ออกมาเป็น Pie chart ดังนี้ :

![output](https://user-images.githubusercontent.com/118663358/233780831-94cec344-06c1-42a3-bd8d-07cb9362db3e.png)
<br><br>
...
เราจะพบว่า Action ที่เป็นกรณี Reset-both เป็นสิ่งที่เกิดขึ้นได้ไม่บ่อยนัก
<br><br>

![output2](https://user-images.githubusercontent.com/118663358/233782786-06959979-7ef0-48c1-9cbc-84da624ca2f4.png)
<br><br>

ในส่วนของ ความสัมพันธ์ ( Correlation ) ระหว่าง Column ก็จะพบว่า ขนาดและจำนวนของ File ไม่มีความเกี่ยวข้องกับระยะเวลาการส่งเลย

และเราได้มีการตัดสินใจว่าจะใช้ Column ทุกอันเข้ามาเป็นข้อมูลในการ Learn <br>
